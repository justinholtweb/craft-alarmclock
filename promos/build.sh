...
# Output: promos/out/alarmclock-promo-N.png at 1920x1080 (rendered at 2x, downsampled).
set -euo pipefail
...
for n in $SLIDES; do
  "$CHROME" \
    ...
    --screenshot="out/alarmclock-promo-$n.png" \
    "file://$PWD/slides.html?s=$n" >/dev/null 2>&1
  sips --resampleWidth 1920 "out/alarmclock-promo-$n.png" >/dev/null
  echo "  built out/alarmclock-promo-$n.png"
done
